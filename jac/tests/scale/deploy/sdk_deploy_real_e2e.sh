...
# This script lives at jac/tests/scale/deploy/, so the repo root is
# five levels up.
REPO_ROOT="$(cd "$(dirname "$0")/../../../.." && pwd)"
DRIVER="${REPO_ROOT}/jac/tests/scale/deploy/sdk_deploy_driver.jac"
...
# Desktop configuration belongs to the workstation; omit it from the pod bundle.
